###########################################################################
## Makefile generated for component 'FullRMX'. 
## 
## Makefile     : FullRMX.mk
## Generated on : Tue Aug 30 10:22:52 2022
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/FullRMX.elf
...
COMPILER_COMMAND_FILE     = FullRMX_comp.rsp
CMD_FILE                  = FullRMX.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/FullRMX.elf
...
DEFINES_SKIPFORSIL = -DARM_MATH_CM4 -DCOMPONENT_FLASHIAP=1 -DCOMPONENT_NSPE=1 -DCOMPONENT_PSA_SRV_EMUL=1 -DCOMPONENT_PSA_SRV_IMPL=1 -DDEVICE_ANALOGIN=1 -DDEVICE_ERROR_RED=1 -DDEVICE_FLASH=1 -DDEVICE_I2C=1 -DDEVICE_I2CSLAVE=1 -DDEVICE_I2C_ASYNCH=1 -DDEVICE_INTERRUPTIN=1 -DDEVICE_LPTICKER=1 -DDEVICE_MPU=1 -DDEVICE_PORTIN=1 -DDEVICE_PORTINOUT=1 -DDEVICE_PORTOUT=1 -DDEVICE_PWMOUT=1 -DDEVICE_RTC=1 -DDEVICE_SERIAL=1 -DDEVICE_SERIAL_ASYNCH=1 -DDEVICE_SERIAL_FC=1 -DDEVICE_SLEEP=1 -DDEVICE_SPI=1 -DDEVICE_SPISLAVE=1 -DDEVICE_SPI_ASYNCH=1 -DDEVICE_STDIO_MESSAGES=1 -DDEVICE_USTICKER=1 -DEXIT_FAILURE=1 -DEXTMODE_DISABLEPRINTF -DEXTMODE_DISABLETESTING -DEXTMODE_DISABLE_ARGS_PROCESSING=1 -DMBED_CONF_PLATFORM_DEFAULT_SERIAL_BAUD_RATE=9600 -DMBED_RAM_SIZE=0x20000 -DMBED_RAM_START=0x20000000 -DMBED_ROM_SIZE=0x80000 -DMBED_ROM_START=0x8000000 -DMBED_TRAP_ERRORS_ENABLED=1 -DNULL=0 -DTARGET_CORTEX -DTARGET_CORTEX_M -DTARGET_FAMILY_STM32 -DTARGET_FF_ARDUINO -DTARGET_FF_MORPHO -DTARGET_LIKE_CORTEX_M4 -DTARGET_LIKE_MBED -DTARGET_M4 -DTARGET_M4F -DTARGET_NAME=NUCLEO_F411RE -DTARGET_NUCLEO_F411RE -DTARGET_RELEASE -DTARGET_STM32F411RE -DTARGET_STM32F411xE -DTARGET_STM32F4 -DTARGET_STM -DTARGET_UVISOR_UNSUPPORTED -DTOOLCHAIN_GCC -DTOOLCHAIN_GCC_ARM -DTOOLCHAIN_object -DTRANSACTION_QUEUE_SIZE_SPI=2 -DUSBHOST_OTHER -DUSB_STM_HAL -DXCP_CUSTOM_PLATFORM -D__CORTEX_M4 -D__FPU_PRESENT=1 -D__FPU_USED=1U -D__MBED__=1 -DSTACK_SIZE=64 -DRT -DMW_RTIOSTREAM_BAUDRATE="115200"
DEFINES_STANDARD = -DMODEL=FullRMX -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_AnalogInput.o MW_PWM.o MW_digitalIO.o xcp_ext_mode.o FullRMX.o FullRMX_data.o xcp_ext_common.o xcp_ext_classic_trigger.o xcp.o xcp_standard.o xcp_daq.o xcp_calibration.o xcp_fifo.o xcp_transport.o xcp_mem_default.o xcp_drv_rtiostream.o xcp_frame_serial.o xcp_ext_param_default_serial.o mw_mbed_interface.o BufferedSerial.o SysTickScheduler.o m3m4m4f_multitasking.o sys_arch.o xcp_platform_timer_mbed.o rtiostream_serial_mbed.o
...
LDFLAGS_SKIPFORSIL = -mcpu=cortex-m4 -mthumb -mlittle-endian -mfpu=fpv4-sp-d16 -mfloat-abi=hard --entry=Reset_Handler --specs=nano.specs --specs=nosys.specs -T"C:\ProgramData\MATLAB\SupportPackages\R2021b\toolbox\target\supportpackages\stmnucleo\registry\../mbed/NUCLEO_F411RE/TOOLCHAIN_GCC_ARM/STM32F411XE.ld" "C:\ProgramData\MATLAB\SupportPackages\R2021b\toolbox\target\supportpackages\stmnucleo\registry\../mbed/NUCLEO_F411RE/TOOLCHAIN_GCC_ARM/*.o"
...
CPP_LDFLAGS_SKIPFORSIL = -mcpu=cortex-m4 -mthumb -mlittle-endian -mfpu=fpv4-sp-d16 -mfloat-abi=hard --entry=Reset_Handler --specs=nano.specs --specs=nosys.specs -T"C:\ProgramData\MATLAB\SupportPackages\R2021b\toolbox\target\supportpackages\stmnucleo\registry\../mbed/NUCLEO_F411RE/TOOLCHAIN_GCC_ARM/STM32F411XE.ld" "C:\ProgramData\MATLAB\SupportPackages\R2021b\toolbox\target\supportpackages\stmnucleo\registry\../mbed/NUCLEO_F411RE/TOOLCHAIN_GCC_ARM/*.o"
...
%.o : $(START_DIR)/FullRMX_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/FullRMX_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/FullRMX_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/FullRMX_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/FullRMX_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
MW_AnalogInput.o : C:/ProgramData/MATLAB/SupportPackages/R2021b/toolbox/target/supportpackages/mbed/src/MW_AnalogInput.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
FullRMX.o : $(START_DIR)/FullRMX_ert_rtw/FullRMX.c
	$(CC) $(CFLAGS) -o "$@" "$<"


FullRMX_data.o : $(START_DIR)/FullRMX_ert_rtw/FullRMX_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/FullRMX_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"
...
mw_mbed_interface.o : C:/ProgramData/MATLAB/SupportPackages/R2021b/toolbox/target/supportpackages/stmnucleo/registry/../STM32F411RE/src/mw_mbed_interface.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
